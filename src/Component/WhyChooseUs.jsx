...
import { FaMoneyBillWave, FaClipboardCheck, FaTachometerAlt, FaUserTie } from 'react-icons/fa';

const features = [
  {
    title: "Affordable & Transparent",
    icon: <FaMoneyBillWave className="text-blue-500 text-5xl mb-4 mx-auto" />,
  },
  {
    title: "Compliance Assured",
    icon: <FaClipboardCheck className="text-blue-500 text-5xl mb-4 mx-auto" />,
  },
  {
    title: "Simplified & Efficient Process",
    icon: <FaTachometerAlt className="text-blue-500 text-5xl mb-4 mx-auto" />,
  },
  {
    title: "Expert Guidance, On-Time Service",
    icon: <FaUserTie className="text-blue-500 text-5xl mb-4 mx-auto" />,
  },
];

const WhyChooseUs = () => {
  return (
    <section className="py-16 bg-white text-center px-6 sm:px-10 lg:px-20">
      {/* Heading */}
